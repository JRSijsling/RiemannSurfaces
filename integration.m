...
{ Printing. }
        vprint RS,1 : "Integration type:",IntSch`Type;
        vprint RS,1 : "Number of abscissas:",IntSch`N;
        vprint RS,1 : "Precision:",IntSch`Prec;
        if assigned IntSch`IntPar then
                vprint RS,1 : "IntPar:",IntSch`IntPar;
        end if;
        if assigned IntSch`IntPar then
                vprint RS,1 : "Bounds:",IntSch`Bounds;
        end if;
        if IntSch`Type eq "GJ" then
                vprint RS,1 : "AlphaBeta:",IntSch`AlphaBeta;
        end if;
end intrinsic;
