...
{ Prining. }
        if e`Terminated then
                vprint RS,1 : "Edge from",e`StPt,"to",e`EndPt,"on Level",e`Level,"and Terminated Branch",e`Branch;
        else
                vprint RS,1 : "Edge from",e`StPt,"to",e`EndPt,"on Level",e`Level,"and Branch",e`Branch;
        end if;
end intrinsic;
