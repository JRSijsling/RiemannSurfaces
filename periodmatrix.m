        ...
        if not assigned X`SmallPeriodMatrix then
                ...
                if Check then
                        ...
                        if MaxSymDiff ge X`Error then
                                vprint RS,1 : "Small period matrix: Requested accuracy could not not be reached.";
                                vprint RS,1 : "Significant digits:",Floor(-Log(10,MaxSymDiff));
                        end if;
        ...
        for l in [1..NPath] do
                ...
                for k in [1..g] do
                        ...
                        if Val gt X`Error then
                                vprint RS,1 : "Warning: sum of path diff values:",Val;
