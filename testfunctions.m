...
{ Test superelliptic period matrices for different families of polynomials }
        ...
        vprint RS,1 : "Testing cyclotomic polynomials...";
        C_n := x^n + 1;
        vprint RS,1 : "C_n:",C_n;
        ...
        // Exponential series
        vprint RS,1 : "Testing exponential series...";
        ...
        vprint RS,1 : "Testing Bernoulli polynomials...";
        ...
        vprint RS,1 : "Testing Legendre polynomials...";
        ...
        vprint RS,1 : "Testing Laguerre polynomials...";
        ...
        vprint RS,1 : "Testing Chebyshev polynomials...";
...
function f_fam(n)
        ...
        vprint RS,1 : "Genus:",Genus(FunctionField(f));
        return f;
end function;
